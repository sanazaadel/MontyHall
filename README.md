...
- Visualizes results using Streamlit for easy interpretation.       
### Requirements    
- Python 3.x    
- Streamlit    
### Installation    
...
2. Adjust the number of trials using the sidebar slider to see how switching versus staying affects win rates.    
